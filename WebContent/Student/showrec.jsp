...
<div id="c">
    ...
    <div id="right">
        ...
        <div class="right">
            <div id="right_box">
                <form method="post" name="modifyForm"  onSubmit="return checkform();">
                    <div class="tags">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table1">
                                    ...
                                    <s:iterator value="teacherlist"  status="st">
                                        <tr>
                                            ...
                                            <td align="right"><s:property value="resAchievement"></s:property> </td>
                                            <td align="right"><s:property value="contact"></s:property> </td>
                                        </tr>
                                    </s:iterator>
